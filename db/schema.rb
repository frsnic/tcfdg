...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "tcdfg_wp_adsPage", id: false, force: :cascade do |t|
  ...
  create_table "tcdfg_wp_aiowps_events", force: :cascade do |t|
  ...
  create_table "tcdfg_wp_aiowps_failed_logins", force: :cascade do |t|
  ...
  create_table "tcdfg_wp_aiowps_global_meta", primary_key: "meta_id", force: :cascade do |t|
  ...
  create_table "tcdfg_wp_aiowps_login_activity", force: :cascade do |t|
    t.integer  "user_id",       limit: 8,                null: false
    t.string   "user_login",    limit: 150,              null: false
  ...
  create_table "tcdfg_wp_aiowps_login_lockdown", force: :cascade do |t|
    t.integer  "user_id",         limit: 8,                null: false
    t.string   "user_login",      limit: 150,              null: false
  ...
  create_table "tcdfg_wp_commentmeta", primary_key: "meta_id", force: :cascade do |t|
    t.integer "comment_id", limit: 8,          default: 0, null: false
    t.string  "meta_key",   limit: 255
    t.text    "meta_value", limit: 4294967295
  end

  add_index "tcdfg_wp_commentmeta", ["comment_id"], name: "comment_id", using: :btree
  add_index "tcdfg_wp_commentmeta", ["meta_key"], name: "meta_key", length: {"meta_key"=>191}, using: :btree

  create_table "tcdfg_wp_comments", primary_key: "comment_ID", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_comments", ["comment_approved", "comment_date_gmt"], name: "comment_approved_date_gmt", using: :btree
  add_index "tcdfg_wp_comments", ["comment_author_email"], name: "comment_author_email", length: {"comment_author_email"=>10}, using: :btree
  add_index "tcdfg_wp_comments", ["comment_date_gmt"], name: "comment_date_gmt", using: :btree
  add_index "tcdfg_wp_comments", ["comment_parent"], name: "comment_parent", using: :btree
  add_index "tcdfg_wp_comments", ["comment_post_ID"], name: "comment_post_ID", using: :btree

  create_table "tcdfg_wp_links", primary_key: "link_id", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_links", ["link_visible"], name: "link_visible", using: :btree

  create_table "tcdfg_wp_nxs_log", id: false, force: :cascade do |t|
  ...
  add_index "tcdfg_wp_nxs_log", ["id"], name: "id", unique: true, using: :btree

  create_table "tcdfg_wp_options", primary_key: "option_id", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_options", ["option_name"], name: "option_name", unique: true, using: :btree

  create_table "tcdfg_wp_postmeta", primary_key: "meta_id", force: :cascade do |t|
    t.integer "post_id",    limit: 8,          default: 0, null: false
    t.string  "meta_key",   limit: 255
    t.text    "meta_value", limit: 4294967295
  end

  add_index "tcdfg_wp_postmeta", ["meta_key"], name: "meta_key", length: {"meta_key"=>191}, using: :btree
  add_index "tcdfg_wp_postmeta", ["post_id"], name: "post_id", using: :btree

  create_table "tcdfg_wp_posts", primary_key: "ID", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_posts", ["post_author"], name: "post_author", using: :btree
  add_index "tcdfg_wp_posts", ["post_name"], name: "post_name", length: {"post_name"=>191}, using: :btree
  add_index "tcdfg_wp_posts", ["post_parent"], name: "post_parent", using: :btree
  add_index "tcdfg_wp_posts", ["post_type", "post_status", "post_date", "ID"], name: "type_status_date", using: :btree

  create_table "tcdfg_wp_statpress", id: false, force: :cascade do |t|
    t.integer  "id",           limit: 3,   null: false
  ...
  add_index "tcdfg_wp_statpress", ["agent"], name: "agent", using: :btree
  add_index "tcdfg_wp_statpress", ["browser"], name: "browser", using: :btree
  add_index "tcdfg_wp_statpress", ["date", "feed", "spider"], name: "date_feed_spider", using: :btree
  add_index "tcdfg_wp_statpress", ["feed", "spider", "browser"], name: "feed_spider_browser", using: :btree
  add_index "tcdfg_wp_statpress", ["feed", "spider", "os"], name: "feed_spider_os", using: :btree
  add_index "tcdfg_wp_statpress", ["id"], name: "id", unique: true, using: :btree
  add_index "tcdfg_wp_statpress", ["ip", "date"], name: "ip_date", using: :btree
  add_index "tcdfg_wp_statpress", ["os"], name: "os", using: :btree
  add_index "tcdfg_wp_statpress", ["referrer"], name: "referrer", length: {"referrer"=>255}, using: :btree
  add_index "tcdfg_wp_statpress", ["search"], name: "search", using: :btree
  add_index "tcdfg_wp_statpress", ["spider", "nation"], name: "spider_nation", using: :btree

  create_table "tcdfg_wp_tabulate_changes", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_tabulate_changes", ["changeset_id"], name: "changeset_id", using: :btree

  create_table "tcdfg_wp_tabulate_changesets", force: :cascade do |t|
    t.datetime "date_and_time",               null: false
    t.integer  "user_id",       limit: 8,     null: false
    t.text     "comment",       limit: 65535
  end

  add_index "tcdfg_wp_tabulate_changesets", ["user_id"], name: "user_id", using: :btree

  create_table "tcdfg_wp_term_relationships", id: false, force: :cascade do |t|
  ...
  add_index "tcdfg_wp_term_relationships", ["term_taxonomy_id"], name: "term_taxonomy_id", using: :btree

  create_table "tcdfg_wp_term_taxonomy", primary_key: "term_taxonomy_id", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_term_taxonomy", ["taxonomy"], name: "taxonomy", using: :btree
  add_index "tcdfg_wp_term_taxonomy", ["term_id", "taxonomy"], name: "term_id_taxonomy", unique: true, using: :btree

  create_table "tcdfg_wp_terms", primary_key: "term_id", force: :cascade do |t|
    t.string  "name",       limit: 200, default: "", null: false
    t.string  "slug",       limit: 200, default: "", null: false
    t.integer "term_group", limit: 8,   default: 0,  null: false
  end

  add_index "tcdfg_wp_terms", ["name"], name: "name", length: {"name"=>191}, using: :btree
  add_index "tcdfg_wp_terms", ["slug"], name: "slug", length: {"slug"=>191}, using: :btree

  create_table "tcdfg_wp_usermeta", primary_key: "umeta_id", force: :cascade do |t|
    t.integer "user_id",    limit: 8,          default: 0, null: false
    t.string  "meta_key",   limit: 255
    t.text    "meta_value", limit: 4294967295
  end

  add_index "tcdfg_wp_usermeta", ["meta_key"], name: "meta_key", length: {"meta_key"=>191}, using: :btree
  add_index "tcdfg_wp_usermeta", ["user_id"], name: "user_id", using: :btree

  create_table "tcdfg_wp_users", primary_key: "ID", force: :cascade do |t|
  ...
  add_index "tcdfg_wp_users", ["user_login"], name: "user_login_key", using: :btree
  add_index "tcdfg_wp_users", ["user_nicename"], name: "user_nicename", using: :btree

  create_table "tcdfg_wp_wpb2d_excluded_files", id: false, force: :cascade do |t|
    t.string  "file",  limit: 255, null: false
    t.boolean "isdir",             null: false
  end

  add_index "tcdfg_wp_wpb2d_excluded_files", ["file"], name: "file", unique: true, using: :btree

  create_table "tcdfg_wp_wpb2d_options", id: false, force: :cascade do |t|
    t.string "name",  limit: 50,  null: false
    t.string "value", limit: 255, null: false
  end

  add_index "tcdfg_wp_wpb2d_options", ["name"], name: "name", unique: true, using: :btree

  create_table "tcdfg_wp_wpb2d_processed_dbtables", id: false, force: :cascade do |t|
    t.string  "name",  limit: 255,             null: false
    t.integer "count", limit: 4,   default: 0, null: false
  end

  add_index "tcdfg_wp_wpb2d_processed_dbtables", ["name"], name: "name", unique: true, using: :btree

  create_table "tcdfg_wp_wpb2d_processed_files", id: false, force: :cascade do |t|
    t.string  "file",     limit: 255,             null: false
    t.integer "offset",   limit: 4,   default: 0, null: false
    t.string  "uploadid", limit: 50
  end

  add_index "tcdfg_wp_wpb2d_processed_files", ["file"], name: "file", unique: true, using: :btree
